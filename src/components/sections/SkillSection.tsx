...
const skillSequence = [
	...
	"Skills: Solidity, Move, ether.js, Sui, Hardhat",
];

const SkillSection = () => {
	const [logs, setLogs] = useState<string[]>([]);
	const isFinished = logs.length === skillSequence.length;
			...
			>
				...
				<div className="flex-grow overflow-y-auto font-mono text-green-400 w-full p-2">
					<div className="bg-gray-900 w-full h-full border-t border-gray-700 shadow-inner flex flex-col p-2">
						...
						{logs.length < skillSequence.length && (
							<div>
								<span className="text-teal-300 font-mono">
									user@macbook:
								</span>
								...
								<TypeAnimation
									sequence={skillSequence.flatMap((cmd) => [
										cmd,
										1000,
